...
export const formText ="Discover Images for Your Preferred Topics";
...
export const CLIENTID = "kt86BEbmb1Q0s4Ynhl9uYlzWqf1_KOWGY5UN0D0oY_U"  //for demo purpose adding in constant file
